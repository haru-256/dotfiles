...
Inline output only. Do not persist findings or adjudication to docs or any plan; planner_v2 owns persistence when it invokes reviewer_v2 during a workflow.
