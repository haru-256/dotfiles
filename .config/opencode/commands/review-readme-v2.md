...
Inline output only. Do not persist findings or adjudication to README or any plan; orchestrator_v2 owns persistence when it invokes reviewer_v2 during a workflow.
