...
- After the plan body is written, append the following living-document sections at the end (if not already present):
  ...
  ## Review Findings
  <!-- This template is also defined in prompts/orchestrator_v2.md. Keep them in sync on every edit. -->

  ### Reviewer Raw Findings
  <!-- Orchestrator copies @reviewer_v2's structured findings verbatim here when invoking @reviewer_v2
